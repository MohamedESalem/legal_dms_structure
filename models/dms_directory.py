...
class DmsDirectory(models.Model):
    ...
    legal_node_type = fields.Selection(
        selection=[
            ...
            ("client_root", _("Client Root")),
            ("client_node", _("Client Directory")),
            ("cases_container", _("Cases Container")),
            ("subjects_container", _("Subjects Container")),
            ("case_root", _("Case Root")),
            ("subject_root", _("Subject Root")),
            ("case_node", _("Case Directory")),
            ("subject_node", _("Subject Directory")),
        ],
        copy=False,
        index=True,
    )
